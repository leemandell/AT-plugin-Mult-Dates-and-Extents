...
public class ResourceComponentBasicInfoPanel extends BYU_DomainEditorFields {
	...
	private void addDateActionPerformed(ActionEvent e) {
		addDateActionPerformed(dateTable, resourceComponentModel);
	}
	...
	private void addPhysicalDescriptionActionPerformed() {
		addPhysicalDescriptionActionPerformed(physicalDescriptionsTable, resourceComponentModel);
	}
